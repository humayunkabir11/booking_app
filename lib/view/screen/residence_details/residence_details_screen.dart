...
class _ResidenceDetailsScreenState extends State<ResidenceDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    double halfDay = allHotelDataList[index].dailyAmount / 2;
              ...
              child: GetBuilder<LocalizationController>(
                ...
                return Column(
                  ...
                  children: [
                            ...
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                  ...
                                  image: CachedNetworkImageProvider(
                                      "${allHotelDataList[index].photo![itemIndex].publicFileUrl}"),
                                ),
                          ...
                          children: [
                                  ...
                                  Text.rich(
                                    TextSpan(
                                      children: [
                                        ...
                                        TextSpan(
                                          text:
                                              "${allHotelDataList[index].ratings ?? 0}",
                            ...
                            Container(
                              ...
                              decoration: ShapeDecoration(
                                color: allHotelDataList[index].status == "active"
                                        ? const Color(0xFFE8EDE6)
                                        : const Color(0xFFF2E1E3),
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(4)),
                              ),
                              child: Text(
                                allHotelDataList[index].status.toString().toUpperCase(),
                                style: GoogleFonts.raleway(
                                  color: allHotelDataList[index].status == "active"
                            ...
                            Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Text(
                                      allHotelDataList[index].category.translation.en != "Personal-House" && allHotelDataList[index].category.translation.en != "Residence"
                                          ? "${allHotelDataList[index].hourlyAmount} FCFA "
                                          : "$halfDay FCFA ",
                                      style: GoogleFonts.raleway(
                                        color: const Color(0xFF818181),
                                        fontSize: 14,
                                ...
                                Row(
                                  children: [
                                    Text(
                                      "${allHotelDataList[index].dailyAmount} FCFA ",
                                      style: GoogleFonts.raleway(
                                        color: const Color(0xFF818181),
                                        fontSize: 14,
                                        fontWeight: FontWeight.w400,
                      ...
                      children: [
                        Expanded(
                          child: ImageWithNumber(
                              ...
                              number: "${allHotelDataList[index].capacity ?? 0}", title: "Capacity".tr,subTitle: "Persons".tr, horizontal: 8),
                        ),
                        Expanded(
                          child: ImageWithNumber(
                              imageName: "assets/icons/bed.svg",title: "Bed".tr,subTitle: "Bed".tr,
                              number: "${allHotelDataList[index].beds ?? 0}", horizontal: 8),
                        ),

                        Expanded(
                          child: ImageWithNumber(
                              imageName: "assets/icons/shower.svg",title: "Shower".tr,subTitle: "Shower".tr,
                              number: "${allHotelDataList[index].baths ?? 0}", horizontal: 8),
                        ),
                      ],
                    ),
                    const SizedBox(height: 16),
                    ...
                    allHotelDataList[index].category.translation.en == "Residence" ||
                        allHotelDataList[index].category.translation.en == "Personal-House"
                        ? Obx(
                          () => Column(
                            children: [
                        ...
                        : allHotelDataList[index].category.translation.en == "Hotel"
                        ? Obx(
                          () => Column(
                        children: [
                              ...
                              child: FittedBox(
                                child: Text(
                                  localizationController.selectedIndex == 0
                                      ? allHotelDataList[index].amenities[i].translation?.fr ?? ""
                      ...
                      children: [
                        Text.rich(
                          TextSpan(
                            children: [
                              TextSpan(
                                text: "${allHotelDataList[index].dailyAmount} FCFA",
                                style: GoogleFonts.openSans(
                                  color: Colors.white,
                                  fontSize: 16,
                                  fontWeight: FontWeight.w600,
                            ...
                            onTap: () {
                              if (startDate.isEmpty && endDate.isEmpty) {
                                ...
                                controller.addResidenceResult(
                                    ...
                                    startDate: startDate,
                                    endDate: allHotelDataList[index].category.translation.en == "Hotel" &&
                                        controller.hrRent[controller.selected.toInt()] == "Hours".tr ? startDate : allHotelDataList[index].category.translation.en != "Hotel"&&  controller.hrRent[controller.selected.toInt()] != "Hours".tr ? endDate : endDate,
                                    ...
                                    requestBy : allHotelDataList[index].category.translation.en == "Hotel" ?
